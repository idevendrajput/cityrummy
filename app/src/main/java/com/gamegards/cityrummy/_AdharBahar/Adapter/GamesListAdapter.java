package com.gamegards.cityrummy._AdharBahar.Adapter;
...
import com.gamegards.cityrummy._AdharBahar.GameActivity;
import com.gamegards.cityrummy._AdharBahar.HorizontalAndhar_Bahar_A;
import com.gamegards.cityrummy._AdharBahar.Model.GameModel;
        ...
        holder.itemView.findViewById(R.id.btnplay).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Variables.HORIZONTAL_ANDHARBAHAR)
                    intent = new Intent(context,HorizontalAndhar_Bahar_A.class);
