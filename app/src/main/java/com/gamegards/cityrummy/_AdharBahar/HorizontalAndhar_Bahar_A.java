package com.gamegards.cityrummy._AdharBahar;
...
//Set the amount of time between each execution (in milliseconds)
    ...
    private void addCardsAndar(String cat,int countnumber) {
        ...
        int width = (int) getResources().getDimension(R.dimen.dt_card_width);
        int height = (int) getResources().getDimension(R.dimen.dt_card_hight);
