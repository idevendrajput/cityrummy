package com.gamegards.cityrummy.PaymentScreen;
...
public class Payment_A extends AppCompatActivity implements View.OnClickListener {
    ...
    private void InitView() {
        ...
        findViewById(R.id.upload).setOnClickListener(v -> {
            Intent intent1 = new Intent(Payment_A.this, Payment_Upload_A.class);
            intent1.putExtra("type", "home_");
            intent1.putExtra("plan_id", plan_id);
            intent1.putExtra("chips_details", chips_details);
            intent1.putExtra("amount", amount);
            intent1.putExtra("mobile", mobile);
            intent1.putExtra("id", id);
            intent1.putExtra("transaction_id", transaction_id_);
...
//                Log.d("Details-->", jo_inside.getString("image"));
    ...
    private void commentDialog(final String payWith) {
        ...
        ly_submit.setOnClickListener(v -> {
            create_Transaction(payWith);
            popupWindow.dismiss();
        });

        ly_close_dialog.setOnClickListener(v -> popupWindow.dismiss());
