...
public class PrivateTablev2 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Funtions.showToast(this, getScreenSize()+""+densityDpi+"  inch "+screenInches,
        ...
        Picasso.with(PrivateTablev2.this).load(Const.IMGAE_PATH + img).into(imgpl1circle);
...
//                        Toast.LENGTH_LONG).show();
                ...
                Functions.showTipsDialog(PrivateTablev2.this, dealer, imgampire, new Callback() {
                    @Override
...
//                showDialogSetting();
    ...
    private void GiftDialog(String players){
        ...
        Functions.showGiftDialog(PrivateTablev2.this, players, new Callback() {
            @Override
        ...
        switchd.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                if (isChecked) {
                    ...
                    // Funtions.showToast(context, "On");

                } else {
                    // Funtions.showToast(context, "Off");
                    SharedPreferences.Editor editor = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE).edit();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Functions.LOGE("PrivateTablev2",""+url+"\n"+response);
...
//                                Toast.LENGTH_LONG).show();
                ...
                Functions.showToast(PrivateTablev2.this, message);
                GameLeave("0");
    ...
    private void GameLeave(final String value) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Const.GAME_TABLE_LEAVE,
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                // Funtions.showToast(PublicTable.this, "Something went wrong", Toast.LENGTH_LONG)
                // .show();
            }
        }) {
            @Override
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Functions.LOGE("PrivateTablev2",""+Const.GAME_STATUS+"\n"+response);
                            ...
                            for (int k = 0; k < jsonArrayuser.length(); k++) {
                                if (k == 0) {
                                    ...
                                    Picasso.with(PrivateTablev2.this).load(Const.IMGAE_PATH + profile_pic).into(imgpl1circle);
                                    ...
                                    if (user_id_player1.equals(prefs.getString("user_id", ""))) {
                                        ...
                                        Functions.showToast(PrivateTablev2.this, "Your are timeout from " +
...
//first player
                                    ...
                                    if (user_id_player2.equals("0")) {
                                        ...
                                        Picasso.with(PrivateTablev2.this).load(Const.IMGAE_PATH + profile_pic1).into(imgpl2circle);
...
//second player
                                    ...
                                    if (user_id_player3.equals("0")) {
                                        ...
                                        Picasso.with(PrivateTablev2.this).load(Const.IMGAE_PATH + profile_pic3).into(imgpl3circle);
...
//third player
                                    ...
                                    if (user_id_player4.equals("0")) {
                                        ...
                                        Picasso.with(PrivateTablev2.this).load(Const.IMGAE_PATH + profile_pic4).into(imgpl4circle);
                                    ...
                                    if (walletplayer5.equals("0")) {
                                        ...
                                        Picasso.with(PrivateTablev2.this).load(Const.IMGAE_PATH + profile_pic5).into(imgpl5circle);
...
//        Funtions.showToast(context, "Distribute Cards");
...
//        Funtions.showToast(context, ""+total_cards);
    }
    ...
    public void showSlideshowCards(){
    ...
    public void makeleavetable() {
        ...
        Picasso.with(PrivateTablev2.this).load(imageResource).into(imgpl1circle);
        Picasso.with(PrivateTablev2.this).load(imageResource).into(imgpl2circle);
        Picasso.with(PrivateTablev2.this).load(imageResource).into(imgpl3circle);
        Picasso.with(PrivateTablev2.this).load(imageResource).into(imgpl4circle);
        Picasso.with(PrivateTablev2.this).load(imageResource).into(imgpl5circle);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (code.equals("200")) {
                                ...
                                // Funtions.showToast(PublicTable.this, message, Toast.LENGTH_LONG)
                                // .show();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Const.GAME_START,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Functions.LOGE("PrivateTablev2",""+Const.GAME_START+"\n"+response);
                        // progressDialog.dismiss();
                        try {
                            JSONObject jsonObject = new JSONObject(response);
                            ...
                            if (code.equalsIgnoreCase("200")) {
                                ...
                                if (jsonObject.has("message")) {
                                    String message = jsonObject.getString("message");
                                    //Funtions.showToast(PublicTable.this, message, Toast
                                    // .LENGTH_LONG).show();
                                }
                        ...
                        try {
                            ...
                            if (code.equalsIgnoreCase("200")) {
                                ...
                                if (jsonObject.has("cards")) {
                                    ...
                                    if (jsonObject.has("message")) {
                                        String message = jsonObject.getString("message");
//                                        Funtions.showToast(PublicTable.this, "Wrong mobile number or password",
//                                                Toast.LENGTH_LONG).show();
                                    }
