...
//                        Toast.LENGTH_LONG).show();
                ...
                Functions.showTipsDialog(CustomsiedTablev3.this, dealer, imgampire, new Callback() {
                    @Override
...
//                showDialogSetting();
    ...
    private void GiftDialog(String players){
        ...
        Functions.showGiftDialog(CustomsiedTablev3.this, players, new Callback() {
            @Override
...
//                                Toast.LENGTH_LONG).show();
                ...
                Functions.showToast(CustomsiedTablev3.this, message);
                GameLeave("0");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Const.GAME_STATUS,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Functions.LOGE("CustomsiedTablev3",""+Const.GAME_STATUS+"\n"+response);
                            ...
                            for (int k = 0; k < jsonArrayuser.length(); k++) {
                                if (k == 0) {
                                    ...
                                    if (user_id_player1.equals(prefs.getString("user_id", ""))) {
                                        ...
                                        Functions.showToast(CustomsiedTablev3.this, "Your are timeout from " +
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Const.GAME_START,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Functions.LOGE("CustomsiedTablev3",""+Const.GAME_START+"\n"+response);
