...
//                        btn_bottom_sheet.setText("Expand Sheet");
        ...
        findViewById(R.id.bottom_sheet).setOnClickListener(view -> {
        ...
        findViewById(R.id.btnrefer).setOnClickListener(v -> {
...
//            CALL_API_TO_VERIFY_SOCIELLOGIN(id, fname +" "+ lname, email);
    ...
    private void CALL_API_TO_VERIFY_SOCIELLOGIN(String id, String name, String email, String gender) {
        ...
        ApiRequest.Call_Api(this, Const.email_login, params, (response, type, bundle) -> {
