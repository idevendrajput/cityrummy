package com.gamegards.cityrummy.Firebase;
...
import com.gamegards.cityrummy.Activity.Splashscreen;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
           ...
           String title = remoteMessage.getNotification().getTitle();
            ...
            if (title != null && !title.equals(""))
                NotificationManager(this, msg, title, "");
        ...
        if (table_id.length() > 0){
             ...
             intent = new Intent(this, PublicTable_New.class);
    ...
    public void NotificationManager(Context context, String title, String heading, String rozarid) {
